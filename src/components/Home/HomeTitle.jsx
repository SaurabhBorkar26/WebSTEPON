...
export default function HomeTitle() {
  return (
    <>
      <div className="bg-[#abdbe3] xl:pb-44"> {/* changed background color to off-white */}
        <div className="w-full pt-8 lg:flex flex-row-reverse">
          ...
          <div className=" flex flex-col text-center items-center py-10 md:w-11/12 lg:w-9/12 lg:items-start lg:ml-10">
            ...
            <p className="text-black text-opacity-60 font-default text-p px-10 py-3 max-w-[750px] text-center lg:px-0 lg:text-start">
